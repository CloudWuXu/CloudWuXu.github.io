...
{% fb_img https://cdn.jsdelivr.net/gh/CloudWuXu/Blog/Post/Optics/5X_Zoom_Infrared/P1_.png  %}
...
替换过程如下图2-8所示:
{% fb_img https://cdn.jsdelivr.net/gh/CloudWuXu/Blog/Post/Optics/5X_Zoom_Infrared/P2.png  %}
<center>图2 近轴面模型</center>
{% fb_img https://cdn.jsdelivr.net/gh/CloudWuXu/Blog/Post/Optics/5X_Zoom_Infrared/P3.png  %}
<center>图3 前固定组替换</center>
{% fb_img https://cdn.jsdelivr.net/gh/CloudWuXu/Blog/Post/Optics/5X_Zoom_Infrared/P4.png  %}
<center>图4 变倍组替换</center>
{% fb_img https://cdn.jsdelivr.net/gh/CloudWuXu/Blog/Post/Optics/5X_Zoom_Infrared/P5.png  %}
<center>图5 变倍组分裂镜片</center>
{% fb_img https://cdn.jsdelivr.net/gh/CloudWuXu/Blog/Post/Optics/5X_Zoom_Infrared/P6.png  %}
<center>图6 补偿组替换</center>
{% fb_img https://cdn.jsdelivr.net/gh/CloudWuXu/Blog/Post/Optics/5X_Zoom_Infrared/P7.png  %}
<center>图7 补偿组分裂镜片</center>
{% fb_img https://cdn.jsdelivr.net/gh/CloudWuXu/Blog/Post/Optics/5X_Zoom_Infrared/P8.png  %}
<center>图8 调焦组替换</center>

## 四. 拨云见日
替换的过程一波三折，看着最后一个近轴面被替换成镜片，光线在构建好的初始结构中自由流畅地穿梭。原来此时暴风雨已过，阳光驱散乌云，天空绽放出一片蔚蓝，心情是多么的舒畅啊！
{% fb_img https://cdn.jsdelivr.net/gh/CloudWuXu/Blog/Post/Optics/5X_Zoom_Infrared/P9_3.png  %}
<center>图9 短焦MTF曲线</center>
{% fb_img https://cdn.jsdelivr.net/gh/CloudWuXu/Blog/Post/Optics/5X_Zoom_Infrared/P9_9.png  %}
<center>图10 中焦MTF曲线</center>
{% fb_img https://cdn.jsdelivr.net/gh/CloudWuXu/Blog/Post/Optics/5X_Zoom_Infrared/P9_15.png  %}
