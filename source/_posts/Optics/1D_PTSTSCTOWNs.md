...
keywords: PT对称 光波导网络
description:
photos: https://cdn.jsdelivr.net/gh/CloudWuXu/Blog@1.1.1/Post/Optics/1D_PTSTSCTOWN/PhotonicModes3.png
mathjax: true
---
...
{% fb_img https://cdn.jsdelivr.net/gh/CloudWuXu/Blog@1.1.1/Post/Optics/1D_PTSTSCTOWN/Model.png  %}
...
光子模式的分布需要由网络的色散关系$cos(K)=f(v)$来确定，当$|f(v)|\le1$时，布洛赫波矢$K$具有实数解，所以该频率的EM在网络中以OPM传播，而$|f(v)|>1$时，布洛赫波矢$K$为复数解，且由于真空和/或普通材料组成的光波导网络只存在衰减机制，所以EM以APM传播。由此可以判断出：在真空和/或普通材料组成的一维三角形三材料光波导网络中，$|f(v)|=1$是光子传播模式的分界点。
 ...
 {% fb_img https://cdn.jsdelivr.net/gh/CloudWuXu/Blog@1.1.1/Post/Optics/1D_PTSTSCTOWN/PhotonicModes1.jpg  %}
 {% fb_img https://cdn.jsdelivr.net/gh/CloudWuXu/Blog@1.1.1/Post/Optics/1D_PTSTSCTOWN/PhotonicModes2.jpg  %}
...
{% fb_img https://cdn.jsdelivr.net/gh/CloudWuXu/Blog@1.1.1/Post/Optics/1D_PTSTSCTOWN/TR_Spectra1.jpg  %}
...
{% fb_img https://cdn.jsdelivr.net/gh/CloudWuXu/Blog@1.1.1/Post/Optics/1D_PTSTSCTOWN/TR_Spectra2.jpg  %}
{% fb_img https://cdn.jsdelivr.net/gh/CloudWuXu/Blog@1.1.1/Post/Optics/1D_PTSTSCTOWN/TR_Spectra3.jpg  %}
...
## 鸣谢
本文精选自我的毕业论文《一维PT对称双联通三角形光波导网络的奇异传输特性》，论文发表在*Chin.Phys.B*上，在这里要感谢杨湘波教授、吴嘉野师兄和郑健师兄的指导，李海盈、林楷彬和郑宏挺同学的帮助。